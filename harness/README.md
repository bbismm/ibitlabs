...
For the long-form story behind each constraint — five real failure cases from the $1k → $10k experiment, plus a workshop arc for teaching — see [docs/why.md](docs/why.md). For a self-guided walkthrough on adapting harness to your own project, see [docs/porting.md](docs/porting.md).
